...
namespace Noobie.Sanguosha.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapSceneOnPlay = "Sanguosha/Load Bootstrap Scene On Play";

        private const string k_DoNotLoadBootstrapSceneOnPlay = "Sanguosha/Don't Load Bootstrap Scene On Play";
        ...
        {
            return SceneManager.GetActiveScene().name.StartsWith(k_TestRunnerSceneName);
        }
    }
}
